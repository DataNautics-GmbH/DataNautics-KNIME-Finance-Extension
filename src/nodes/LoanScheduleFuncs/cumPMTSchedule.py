...
@knext.node(name="CUMPMT Schedule",
            node_type=knext.NodeType.MANIPULATOR,
            icon_path="src\icons\CUMPMT.png",
...
class AmortizationCUMPMTScheduleNode:
    """Generates a complete cumulative payment schedule showing total payments made through each period.

# CUMPMT Schedule Node

This node creates a comprehensive amortization schedule displaying the cumulative total payments (principal + interest) made from the beginning of the loan through each payment period. This provides a clear view of the total cash outflow progression over the life of the loan and is essential for cash flow analysis and payment tracking.
...
The node generates a detailed payment schedule with these columns:
...
**Cumulative_Payments_Paid**: Running total of all payments made from period 1 through the current period (includes both principal and interest portions)
...
"""
    ...
    def configure(self, configure_context, input_schema):
        return input_schema.append([
            ...
            knext.Column(knext.double(), "Cumulative_Payments_Paid")
        ])
    ...
    def execute(self, exec_context, input_table):
        ...
        output_columns = input_columns + [
            'Period', 'Cumulative_Payments_Paid'
        ]
        ...
        for _, row in df.iterrows():
            ...
            for period in range(1, nper + 1):
                ...
                cumulative_payment += abs(pmt)

                
                # Add new columns
                new_row.extend([
                    period,                  # Period
                    cumulative_payment,      # Cum PMT
                ])
        ...
        for col in result_df.columns:
            ...
            elif col in ['Cumulative_Payments_Paid']:
