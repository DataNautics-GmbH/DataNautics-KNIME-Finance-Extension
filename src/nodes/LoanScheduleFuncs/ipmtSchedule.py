...
@knext.node(name="IPMT Schedule",
            node_type=knext.NodeType.MANIPULATOR,
            icon_path="src\icons\IPMTSCHEDULE.png",
...
class AmortizationIPMTScheduleNode:
    """Generates a complete interest payment schedule showing interest charges for each payment period.

# IPMT Schedule Node

This node creates a comprehensive schedule displaying the interest payment component for every period throughout the loan term. This schedule shows how interest charges change over time, typically starting higher in early periods and decreasing as the principal balance is reduced through amortization.
...
The node generates a detailed interest payment schedule with these columns:
...
**IPMT**: Interest payment amount for each specific period, showing how interest charges decrease over time as the principal balance is reduced
"""
