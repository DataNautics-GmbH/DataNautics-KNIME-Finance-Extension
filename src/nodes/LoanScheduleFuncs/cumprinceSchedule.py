...
@knext.node(name="CUMPRINC Schedule",
            node_type=knext.NodeType.MANIPULATOR,
            icon_path="src\icons\CUMPRINCSCHEDULE.png",
...
class AmortizationCUMPRINCScheduleNode:
    """Generates a complete cumulative principal payment schedule showing total principal reduction through each period.

# CUMPRINCE Schedule Node

This node creates a comprehensive amortization schedule displaying the cumulative principal payments made from the beginning of the loan through each payment period. This schedule tracks equity building and loan balance reduction over time, providing essential information for understanding how much of the original loan principal has been paid down at any point during the loan term.
...
The node generates a detailed principal payment schedule with these columns:
...
**Cumulative_Principal_Paid**: Running total of all principal payments made from period 1 through the current period, showing how much of the original loan balance has been paid down
"""
    ...
    def execute(self, exec_context, input_table):
        ...
        output_columns = input_columns + [
            'Period', 'Cumulative_Principal_Paid'
        ]
        ...
        for col in result_df.columns:
            ...
            elif col in [ 'Cumulative_Principal_Paid']:
