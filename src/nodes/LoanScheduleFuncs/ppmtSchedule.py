...
import logging
#from utils.category import loan_schedule_category
...
@knext.node(name="PPMT Schedule",
            node_type=knext.NodeType.MANIPULATOR,
            icon_path="src\icons\PPMTSCHEDULE.png",
...
class AmortizationPPMTScheduleNode:
    """Generates a complete principal payment schedule showing principal reduction for each payment period.

# PPMT Schedule Node

This node creates a comprehensive schedule displaying the principal payment component for every period throughout the loan term. This schedule shows how principal payments change over time, typically starting lower in early periods and increasing as the interest portion decreases through standard amortization.
...
**PPMT**: Principal payment amount for each specific period, showing how principal reduction increases over time as interest charges decrease
"""
